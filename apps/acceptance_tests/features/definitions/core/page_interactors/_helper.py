...
def _get_header_positions(text_in_headers):
    """
    ...
    """
    table = finder.find_table_with_column_header(text_in_headers)
    column_headers = finder.find_element_by_xpath('//th', table)
    headers_positions = {}
    current_position = 1
    for header in column_headers:
        if header.text in text_in_headers:
